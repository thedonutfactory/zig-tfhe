...
pub fn main() !void {
    ...
    for (security_levels) |level| {
        ...
        std.log.info("TLWE Lv0: N={}, alpha={}", .{ level.params.tlwe_lv0.n, level.params.tlwe_lv0.alpha });
        std.log.info("TLWE Lv1: N={}, alpha={}", .{ level.params.tlwe_lv1.n, level.params.tlwe_lv1.alpha });
        ...
        _ = try tfhe.key.SecretKey.init(allocator);
